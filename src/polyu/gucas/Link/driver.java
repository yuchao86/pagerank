...
import polyu.gucas.Link.PageRankMap;
import polyu.gucas.Link.PageRankReduce;
import polyu.gucas.Link.CleanupMap;
import polyu.gucas.Link.CleanupReduce;
...
public class driver {
	public static void main(String[] args) throws Exception {
		...
		FileInputFormat.setInputPaths(conf, new Path("../../data/assign3"));
